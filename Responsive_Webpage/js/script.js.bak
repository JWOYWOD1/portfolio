...
var workExpHtml = "snippets/WorkExp.html"
var eduHtml = "snippets/Education.html";
var skillsHtml = "snippets/Skills.html";
...
function buildWorkExpHTML (categories) {
  ...
  $ajaxUtils.sendGetRequest(
    workExpHtml,
    function (workExpHtml) {

     
		insertHtml("#main-content", workExpHtml);
    },
    false); // False here because we are getting just regular HTML from the server, so no need to process JSON.
}
